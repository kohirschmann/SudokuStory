...
/**
 * This class provides a method for generating a valid 9x9 Sudoku puzzle (easy mode).
 */
public class Sudoku_generator_easy {
	/**
     ...
     * to check if it's valid. If it is, the puzzle with the initial forty five numbers is returned.(retrieved from the solved puzzle)
